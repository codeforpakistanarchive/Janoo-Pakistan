...
?>
  <div id="isotope-container" class="row">
    ...
    <?php foreach ( $rows as $id => $row ): ?>
      ...
      ?>
      <div class="span3 isotope-element isotope-element-<?php print $count; ?> <?php print $classlist; ?>" data-category="<?php print $classlist; ?>" <?php print $bgstyle ?>><div class="inner">
        <?php print $row; ?>
      </div></div>
      <?php 
      // reset
